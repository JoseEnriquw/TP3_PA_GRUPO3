...
public class UtilsSQL {
    ...
    public static String QUERY_LOGIN = "select Nombre,Correo from usuarios where Correo = ? and Contrasenia = ?";
    ...
    public static String SELECT_ALL_PARQUEO = "select ID,Matricula,Tiempo from PARQUEO";
